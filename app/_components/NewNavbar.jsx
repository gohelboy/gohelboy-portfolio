...
const NewNavbar = () => {
  ...
  return (
    <nav
      className={`${mate_sc.className} fixed top-7 left-1/2 transform -translate-x-1/2  w-full z-[10] flex items-center justify-center`}
    >
      <motion.div
        ref={menuRef}
      ...
      <motion.div
        ...
        className={cn(
          "justify-between flex items-center w-[777px] rounded-xl p-3 z-[2] bg-[--primary-bg]"
        )}
      >
        <Image
          src={"./signature.svg"}
