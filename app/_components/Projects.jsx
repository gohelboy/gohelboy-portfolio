...
import { IconBootstrap, IconConvex, IconCSS, IconExpress, IconFirebase, IconHTML, IconLinkArrow, IconMongo, IconNextJS, IconNODE, IconPartNote, IconReact, IconRedux, IconSCSS, IconShadCN, IconSQL, IconTailwind } from './icons'
...
const Projects = () => {
    const Projects = [
        ...
        {
            logo: <img src={"/pw.png"} width={100} height={100} alt='Property Watch' />,
        ...
        {
            logo: <img src={"/bingepedia.png"} width={150} height={150} alt='Bingepedia' />,
        ...
        },
        {
            ...
            icons: [IconReact, IconRedux, IconHTML, IconCSS, IconMongo, IconExpress, IconNODE],
            image: <img src={"/tsp1.jpg"} width={700} height={700} alt='tiffin service provider' />,
        },
    ];
    ...
    return (
        <section id="projects" className='mx-[18px] flex items-center justify-center py-[100px]'>
            <div className='w-full md:max-w-[1140px] 2xl:max-w-[1280px] flex flex-col gap-9'>
                <div className='text-5xl md:text-6xl 2xl:text-7xl text-center'>Projects</div>
