...
const Contact = () => {
    ...
    return (
        <section id='#about' className={`h-fit w-full flex flex-col gap-3 items-center my-[100px] ${judson.className}`}>
                        ...
                        <div className='flex w-full flex-col gap-7'>
                            ...
                            <div className={`flex flex-col gap-4`}>
                                <div className='flex flex-col w-full'>
                                    ...
                                    <input id='last_name' className='w-full h-12 p-3 mt-1 font-bold text-xl rounded-lg text-[--primary-bg] bg-[--secondary-bg]' />
                                </div>
                                <div className='flex flex-col w-full'>
                                ...
                                <div className='flex flex-col w-full'>
                                    ...
                                    <textarea id='email ' rows={5} className='w-full mt-1 p-3 font-bold text-[--primary-bg] text-xl  rounded-lg bg-[--secondary-bg]' />
                                </div>
