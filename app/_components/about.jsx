                ...
                <div className='flex flex-col gap-7 md:flex-row justify-between'>
                    <div className='h-full flex justify-between'>
                        <div className=''>
                            ...
                            <div className={`${mate_sc.className} text-6xl md:text-9xl relative group`}>
                                <div>Dwarkesh</div>
                                ...
                                <div
                                    className={"absolute top-5 md:top-10 right-5 opacity-0 transition-all duration-300 delay-100 group-hover:opacity-100 group-hover:top-0 group-hover:md:top-[15px] group-hover:right-[10px]"}>
                                    <IconStar className={"size-3"} />
                                </div>
                                <div
                                    className='absolute top-0 md:top-[15px] right-[-20px] opacity-100 rotate-0 transition-all duration-300 group-hover:rotate-90'>
                                    <IconStar className="size-5 md:size-6" />
                                </div>
                                <div
                                    className={"absolute top-7 md:top-16 right-5 opacity-0 transition-all duration-300 delay-100 group-hover:opacity-100 group-hover:top-7 group-hover:md:top-11 group-hover:-right-5"}>
                                    <IconStar className={"size-3"} />
                                </div>
                            </div>
                        </div>
